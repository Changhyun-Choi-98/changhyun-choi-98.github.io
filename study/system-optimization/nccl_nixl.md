...
* Ring: 큰 message에서 bandwidth를 잘 활용한다.
* Tree: 작은 message에서 latency를 줄이기 좋다.
* PAT(Parallel Aggregated Tree): ring-like throughput과 tree-like latency를 함께 노리는 hybrid 방식이다.

...
게임용이지만, 개인 AI 연구/LoRA/소형 LLM inference/robotics prototype에도 많이 쓴다. 전체 목록은 [여기](https://www.nvidia.com/en-us/geforce/graphics-cards/){:target="_blank" rel="noopener noreferrer"}를 보면 된다.

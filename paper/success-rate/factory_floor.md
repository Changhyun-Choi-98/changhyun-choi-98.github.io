...
엄청나게 기발한 아이디어가 돋보이는 논문도 아니고, 실험 결과도 충분히 자세하게 보여주지 않은 것 같다. 하지만 lessons를 보면서 어떻게 보면 당연하게 생각할 수도 있는 것들을 다시 한번 곱씹어볼 기회를 가졌다는 것 만으로도 의미가 있다고 생각한다. 또한 $\pi$0.5를 이렇게 학습시켰을 때 어떤 지점에서 성능이 안나오는지에 대해 감을 잡아보는 것도 valuable하다고 생각한다.
